...
fig, ax0 = plt.subplots(1, 1, figsize=(16, 2.4))
...
legend = ax0.legend(handles, labels, frameon=False, loc="upper center", bbox_to_anchor=(0.5, 1.05), ncol=int(math.ceil(len(settings) / 1)), columnspacing=0.5, fontsize=20)
