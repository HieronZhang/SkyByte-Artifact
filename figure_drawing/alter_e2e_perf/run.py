...
legend = ax0.legend(handles, labels, frameon=False, loc="upper center", bbox_to_anchor=(0.5, 1.05), ncol=int(math.ceil(len(settings) / 2)), columnspacing=1.5)
