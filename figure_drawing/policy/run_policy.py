...
ax0.set_yticks(np.arange(0, 2.6, 0.5))
ax0.set_ylim([0, 1.8])
...
legend = ax0.legend(handles, labels, frameon=False, loc="upper center", bbox_to_anchor=(0.5, 1.05), ncol=int(4), columnspacing=0.5)
