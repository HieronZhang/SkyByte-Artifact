...
normalize_base = None
normalize_base = "0.5MB"

# hatch_color = "#78756e"
hatch_color = "white"

color_arr = colors_light4
hatch_arr = ["", "-", "/", "\\", "x", "xx", "++", "..", "", "-"]
...
output_file = os.path.join(script_dir, "PerfSensitivityLog")
...
ax0.set_yticks(np.arange(0, 1.4, 0.2))
ax0.set_ylim([0, 1.8])
...
if normalize_base is not None:
  ...
  y_label = "Execution\nTime"
ax0.set_ylabel(y_label, fontsize=23)
...
legend = ax0.legend(handles, labels, frameon=False, loc="upper left", bbox_to_anchor=(0, 1.05), ncol=5, columnspacing=2.5)
