...
class all_stats_c {
	public:
		...
		COUNT_Stat* m_SCHED_FAILED_NO_AVAILABLE_PORTS;
		COUNT_Stat* m_SCHED_FAILED_NO_MEM_REQ_SLOTS;
		COUNT_Stat* m_SCHED_FAILED_NO_AVAILABLE_SIMD_UNIT;
		COUNT_Stat* m_SCHED_FAILED_FENCE_ACTIVE;
		COUNT_Stat* m_SCHED_FAILED_MEM_MANAGEMENT;
		...
		// ============= ../def/inst.stat.def =============
		COUNT_Stat* m_PARENT_UOP;
		COUNT_Stat* m_CHILD_UOP_READ;
		...
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_ADOX_ADCX;
		...
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_AVX512;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_AVX512_4FMAPS;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_AVX512_4VNNIW;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_AVX512_BITALG;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_AVX512_VBMI;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_AVX512_VP2INTERSECT;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_BINARY;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_BITBYTE;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_BLEND;
		...
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_CET;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_CLDEMOTE;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_CLFLUSHOPT;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_CLWB;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_CLZERO;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_CMOV;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_COMPRESS;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_COND_BR;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_CONFLICT;
		...
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_ENQCMD;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_EXPAND;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_FCMOV;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_FLAGOP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_FMA4;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_GATHER;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_GFNI;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_IFMA;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_INTERRUPT;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_IO;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_IOSTRINGOP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_KMASK;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_LOGICAL;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_LOGICAL_FP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_LZCNT;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_MISC;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_MMX;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_MOVDIR;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_MPX;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_NOP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_PCLMULQDQ;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_PCONFIG;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_PKU;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_POP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_PREFETCH;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_PREFETCHWT1;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_PT;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_PUSH;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_RDPID;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_RDPRU;
		...
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SCATTER;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SEGOP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SEMAPHORE;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SETCC;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SGX;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SHA;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SHIFT;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_SMAP;
		...
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_VAES;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_VBMI2;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_VFMA;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_VIA_PADLOCK;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_VPCLMULQDQ;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_VTX;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_WAITPKG;
		...
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_TR_MUL;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_TR_DIV;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_TR_FMUL;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_TR_FDIV;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_TR_NOP;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_PREFETCH_NTA;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_PREFETCH_T0;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_PREFETCH_T1;
		COUNT_Stat* m_OP_CAT_XED_CATEGORY_PREFETCH_T2;
		...
		COUNT_Stat* m_OP_CAT_GED_ILLEGAL;
		COUNT_Stat* m_OP_CAT_GED_MOV;
		COUNT_Stat* m_OP_CAT_GED_SEL;
		COUNT_Stat* m_OP_CAT_GED_MOVI;
		COUNT_Stat* m_OP_CAT_GED_NOT;
		COUNT_Stat* m_OP_CAT_GED_AND;
		COUNT_Stat* m_OP_CAT_GED_OR;
		COUNT_Stat* m_OP_CAT_GED_XOR;
		COUNT_Stat* m_OP_CAT_GED_SHR;
		COUNT_Stat* m_OP_CAT_GED_SHL;
		COUNT_Stat* m_OP_CAT_GED_SMOV;
		COUNT_Stat* m_OP_CAT_GED_ASR;
		COUNT_Stat* m_OP_CAT_GED_CMP;
		COUNT_Stat* m_OP_CAT_GED_CMPN;
		COUNT_Stat* m_OP_CAT_GED_CSEL;
		COUNT_Stat* m_OP_CAT_GED_BFREV;
		COUNT_Stat* m_OP_CAT_GED_BFE;
		COUNT_Stat* m_OP_CAT_GED_BFI1;
		COUNT_Stat* m_OP_CAT_GED_BFI2;
		COUNT_Stat* m_OP_CAT_GED_JMPI;
		COUNT_Stat* m_OP_CAT_GED_BRD;
		COUNT_Stat* m_OP_CAT_GED_IF;
		COUNT_Stat* m_OP_CAT_GED_BRC;
		COUNT_Stat* m_OP_CAT_GED_ELSE;
		COUNT_Stat* m_OP_CAT_GED_ENDIF;
		COUNT_Stat* m_OP_CAT_GED_WHILE;
		COUNT_Stat* m_OP_CAT_GED_BREAK;
		COUNT_Stat* m_OP_CAT_GED_CONT;
		COUNT_Stat* m_OP_CAT_GED_HALT;
		COUNT_Stat* m_OP_CAT_GED_CALLA;
		COUNT_Stat* m_OP_CAT_GED_CALL;
		COUNT_Stat* m_OP_CAT_GED_RET;
		COUNT_Stat* m_OP_CAT_GED_GOTO;
		COUNT_Stat* m_OP_CAT_GED_JOIN;
		COUNT_Stat* m_OP_CAT_GED_WAIT;
		COUNT_Stat* m_OP_CAT_GED_SEND;
		COUNT_Stat* m_OP_CAT_GED_SENDC;
		COUNT_Stat* m_OP_CAT_GED_SENDS;
		COUNT_Stat* m_OP_CAT_GED_SENDSC;
		COUNT_Stat* m_OP_CAT_GED_MATH;
		COUNT_Stat* m_OP_CAT_GED_ADD;
		COUNT_Stat* m_OP_CAT_GED_MUL;
		COUNT_Stat* m_OP_CAT_GED_AVG;
		COUNT_Stat* m_OP_CAT_GED_FRC;
		COUNT_Stat* m_OP_CAT_GED_RNDU;
		COUNT_Stat* m_OP_CAT_GED_RNDD;
		COUNT_Stat* m_OP_CAT_GED_RNDE;
		COUNT_Stat* m_OP_CAT_GED_RNDZ;
		COUNT_Stat* m_OP_CAT_GED_MAC;
		COUNT_Stat* m_OP_CAT_GED_MACH;
		COUNT_Stat* m_OP_CAT_GED_LZD;
		COUNT_Stat* m_OP_CAT_GED_FBH;
		COUNT_Stat* m_OP_CAT_GED_FBL;
		COUNT_Stat* m_OP_CAT_GED_CBIT;
		COUNT_Stat* m_OP_CAT_GED_ADDC;
		COUNT_Stat* m_OP_CAT_GED_SUBB;
		COUNT_Stat* m_OP_CAT_GED_SAD2;
		COUNT_Stat* m_OP_CAT_GED_SADA2;
		COUNT_Stat* m_OP_CAT_GED_DP4;
		COUNT_Stat* m_OP_CAT_GED_DPH;
		COUNT_Stat* m_OP_CAT_GED_DP3;
		COUNT_Stat* m_OP_CAT_GED_DP2;
		COUNT_Stat* m_OP_CAT_GED_LINE;
		COUNT_Stat* m_OP_CAT_GED_PLN;
		COUNT_Stat* m_OP_CAT_GED_MAD;
		COUNT_Stat* m_OP_CAT_GED_LRP;
		COUNT_Stat* m_OP_CAT_GED_MADM;
		COUNT_Stat* m_OP_CAT_GED_NOP;
		COUNT_Stat* m_OP_CAT_GED_ROR;
		COUNT_Stat* m_OP_CAT_GED_ROL;
		COUNT_Stat* m_OP_CAT_GED_DP4A;
		COUNT_Stat* m_OP_CAT_GED_F32TO16;
		COUNT_Stat* m_OP_CAT_GED_F16TO32;
		COUNT_Stat* m_OP_CAT_GED_DIM;
		COUNT_Stat* m_OP_CAT_GED_INVALID;
		...
		COUNT_Stat* m_LLC_HIT_CPU;
		COUNT_Stat* m_LLC_HIT_GPU;
		COUNT_Stat* m_LLC_MISS_CPU;
		COUNT_Stat* m_LLC_MISS_GPU;
		COUNT_Stat* m_LLC_HIT_PROMOTION_CPU;
		COUNT_Stat* m_LLC_HIT_PROMOTION_GPU;
		...
		COUNT_Stat* m_UNIQUE_PAGE;
		COUNT_Stat* m_REALLOCATION;
		DIST_Stat* m_DIST_TLB_HIT;
		COUNT_Stat* m_TLB_HIT;
		COUNT_Stat* m_TLB_MISS;
		DIST_Stat* m_DIST_PAGETABLE_HIT;
		COUNT_Stat* m_PAGETABLE_HIT;
		COUNT_Stat* m_PAGETABLE_MISS;
		COUNT_Stat* m_EVICTION;
		COUNT_Stat* m_AVG_PAGE_FAULTS_PER_BATCH_BASE;
		RATIO_Stat* m_AVG_PAGE_FAULTS_PER_BATCH;
		RATIO_Stat* m_MAX_PAGE_FAULTS_PER_BATCH;
		...
		COUNT_Stat* m_NOC_IDLE_CHANNEL_LLC;
		...
		COUNT_Stat* m_NOC_AVG_WAIT_IN_ROUTER_BASE_LLC;
		...
		RATIO_Stat* m_NOC_AVG_WAIT_IN_ROUTER_LLC;
