...
all_stats_c::all_stats_c(ProcessorStatistics* procStat) {
	...
	m_SCHED_FAILED_NO_AVAILABLE_PORTS = (COUNT_Stat*) new DISTMember_Stat("SCHED_FAILED_NO_AVAILABLE_PORTS", "core.stat.out", SCHED_FAILED_NO_AVAILABLE_PORTS, SCHED_FAILED_REASON_SUCCESS);
	m_SCHED_FAILED_NO_MEM_REQ_SLOTS = (COUNT_Stat*) new DISTMember_Stat("SCHED_FAILED_NO_MEM_REQ_SLOTS", "core.stat.out", SCHED_FAILED_NO_MEM_REQ_SLOTS, SCHED_FAILED_REASON_SUCCESS);
	m_SCHED_FAILED_NO_AVAILABLE_SIMD_UNIT = (COUNT_Stat*) new DISTMember_Stat("SCHED_FAILED_NO_AVAILABLE_SIMD_UNIT", "core.stat.out", SCHED_FAILED_NO_AVAILABLE_SIMD_UNIT, SCHED_FAILED_REASON_SUCCESS);
	...
	m_SCHED_FAILED_MEM_MANAGEMENT = (COUNT_Stat*) new DISTMember_Stat("SCHED_FAILED_MEM_MANAGEMENT", "core.stat.out", SCHED_FAILED_MEM_MANAGEMENT, SCHED_FAILED_REASON_SUCCESS);
	...
	m_CYC_COUNT_ACC = new COUNT_Stat("CYC_COUNT_ACC", "general.stat.out", CYC_COUNT_ACC);
	...
	// ============= ../def/inst.stat.def =============
	m_PARENT_UOP = new COUNT_Stat("PARENT_UOP", "inst.stat.out", PARENT_UOP);
	m_CHILD_UOP_READ = new COUNT_Stat("CHILD_UOP_READ", "inst.stat.out", CHILD_UOP_READ);
	...
	m_OP_CAT_XED_CATEGORY_ADOX_ADCX = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_ADOX_ADCX", "inst.stat.out", OP_CAT_XED_CATEGORY_ADOX_ADCX, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_AVX512 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_AVX512", "inst.stat.out", OP_CAT_XED_CATEGORY_AVX512, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_AVX512_4FMAPS = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_AVX512_4FMAPS", "inst.stat.out", OP_CAT_XED_CATEGORY_AVX512_4FMAPS, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_AVX512_4VNNIW = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_AVX512_4VNNIW", "inst.stat.out", OP_CAT_XED_CATEGORY_AVX512_4VNNIW, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_AVX512_BITALG = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_AVX512_BITALG", "inst.stat.out", OP_CAT_XED_CATEGORY_AVX512_BITALG, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_AVX512_VBMI = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_AVX512_VBMI", "inst.stat.out", OP_CAT_XED_CATEGORY_AVX512_VBMI, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_AVX512_VP2INTERSECT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_AVX512_VP2INTERSECT", "inst.stat.out", OP_CAT_XED_CATEGORY_AVX512_VP2INTERSECT, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_BLEND = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_BLEND", "inst.stat.out", OP_CAT_XED_CATEGORY_BLEND, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_CET = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_CET", "inst.stat.out", OP_CAT_XED_CATEGORY_CET, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_CLDEMOTE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_CLDEMOTE", "inst.stat.out", OP_CAT_XED_CATEGORY_CLDEMOTE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_CLFLUSHOPT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_CLFLUSHOPT", "inst.stat.out", OP_CAT_XED_CATEGORY_CLFLUSHOPT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_CLWB = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_CLWB", "inst.stat.out", OP_CAT_XED_CATEGORY_CLWB, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_CLZERO = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_CLZERO", "inst.stat.out", OP_CAT_XED_CATEGORY_CLZERO, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_COMPRESS = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_COMPRESS", "inst.stat.out", OP_CAT_XED_CATEGORY_COMPRESS, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_CONFLICT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_CONFLICT", "inst.stat.out", OP_CAT_XED_CATEGORY_CONFLICT, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_ENQCMD = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_ENQCMD", "inst.stat.out", OP_CAT_XED_CATEGORY_ENQCMD, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_EXPAND = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_EXPAND", "inst.stat.out", OP_CAT_XED_CATEGORY_EXPAND, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_GATHER = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_GATHER", "inst.stat.out", OP_CAT_XED_CATEGORY_GATHER, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_GFNI = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_GFNI", "inst.stat.out", OP_CAT_XED_CATEGORY_GFNI, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_IFMA = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_IFMA", "inst.stat.out", OP_CAT_XED_CATEGORY_IFMA, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_KMASK = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_KMASK", "inst.stat.out", OP_CAT_XED_CATEGORY_KMASK, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_LOGICAL_FP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_LOGICAL_FP", "inst.stat.out", OP_CAT_XED_CATEGORY_LOGICAL_FP, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_MOVDIR = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_MOVDIR", "inst.stat.out", OP_CAT_XED_CATEGORY_MOVDIR, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_MPX = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_MPX", "inst.stat.out", OP_CAT_XED_CATEGORY_MPX, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_PCONFIG = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_PCONFIG", "inst.stat.out", OP_CAT_XED_CATEGORY_PCONFIG, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_PKU = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_PKU", "inst.stat.out", OP_CAT_XED_CATEGORY_PKU, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_PREFETCHWT1 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_PREFETCHWT1", "inst.stat.out", OP_CAT_XED_CATEGORY_PREFETCHWT1, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_PT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_PT", "inst.stat.out", OP_CAT_XED_CATEGORY_PT, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_RDPID = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_RDPID", "inst.stat.out", OP_CAT_XED_CATEGORY_RDPID, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_RDPRU = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_RDPRU", "inst.stat.out", OP_CAT_XED_CATEGORY_RDPRU, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_SCATTER = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_SCATTER", "inst.stat.out", OP_CAT_XED_CATEGORY_SCATTER, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_SETCC = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_SETCC", "inst.stat.out", OP_CAT_XED_CATEGORY_SETCC, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_SGX = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_SGX", "inst.stat.out", OP_CAT_XED_CATEGORY_SGX, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_SHA = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_SHA", "inst.stat.out", OP_CAT_XED_CATEGORY_SHA, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_SMAP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_SMAP", "inst.stat.out", OP_CAT_XED_CATEGORY_SMAP, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_VAES = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_VAES", "inst.stat.out", OP_CAT_XED_CATEGORY_VAES, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_VBMI2 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_VBMI2", "inst.stat.out", OP_CAT_XED_CATEGORY_VBMI2, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_VIA_PADLOCK = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_VIA_PADLOCK", "inst.stat.out", OP_CAT_XED_CATEGORY_VIA_PADLOCK, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_VPCLMULQDQ = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_VPCLMULQDQ", "inst.stat.out", OP_CAT_XED_CATEGORY_VPCLMULQDQ, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_WAITPKG = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_WAITPKG", "inst.stat.out", OP_CAT_XED_CATEGORY_WAITPKG, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_XED_CATEGORY_TR_MUL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_TR_MUL", "inst.stat.out", OP_CAT_XED_CATEGORY_TR_MUL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_TR_DIV = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_TR_DIV", "inst.stat.out", OP_CAT_XED_CATEGORY_TR_DIV, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_TR_FMUL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_TR_FMUL", "inst.stat.out", OP_CAT_XED_CATEGORY_TR_FMUL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_TR_FDIV = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_TR_FDIV", "inst.stat.out", OP_CAT_XED_CATEGORY_TR_FDIV, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_TR_NOP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_TR_NOP", "inst.stat.out", OP_CAT_XED_CATEGORY_TR_NOP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_PREFETCH_NTA = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_PREFETCH_NTA", "inst.stat.out", OP_CAT_XED_CATEGORY_PREFETCH_NTA, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_PREFETCH_T0 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_PREFETCH_T0", "inst.stat.out", OP_CAT_XED_CATEGORY_PREFETCH_T0, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_PREFETCH_T1 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_PREFETCH_T1", "inst.stat.out", OP_CAT_XED_CATEGORY_PREFETCH_T1, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_XED_CATEGORY_PREFETCH_T2 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_XED_CATEGORY_PREFETCH_T2", "inst.stat.out", OP_CAT_XED_CATEGORY_PREFETCH_T2, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_OP_CAT_GED_ILLEGAL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_ILLEGAL", "inst.stat.out", OP_CAT_GED_ILLEGAL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_MOV = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_MOV", "inst.stat.out", OP_CAT_GED_MOV, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_SEL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_SEL", "inst.stat.out", OP_CAT_GED_SEL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_MOVI = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_MOVI", "inst.stat.out", OP_CAT_GED_MOVI, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_NOT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_NOT", "inst.stat.out", OP_CAT_GED_NOT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_AND = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_AND", "inst.stat.out", OP_CAT_GED_AND, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_OR = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_OR", "inst.stat.out", OP_CAT_GED_OR, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_XOR = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_XOR", "inst.stat.out", OP_CAT_GED_XOR, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_SHR = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_SHR", "inst.stat.out", OP_CAT_GED_SHR, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_SHL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_SHL", "inst.stat.out", OP_CAT_GED_SHL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_SMOV = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_SMOV", "inst.stat.out", OP_CAT_GED_SMOV, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_ASR = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_ASR", "inst.stat.out", OP_CAT_GED_ASR, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_CMP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_CMP", "inst.stat.out", OP_CAT_GED_CMP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_CMPN = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_CMPN", "inst.stat.out", OP_CAT_GED_CMPN, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_CSEL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_CSEL", "inst.stat.out", OP_CAT_GED_CSEL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_BFREV = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_BFREV", "inst.stat.out", OP_CAT_GED_BFREV, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_BFE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_BFE", "inst.stat.out", OP_CAT_GED_BFE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_BFI1 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_BFI1", "inst.stat.out", OP_CAT_GED_BFI1, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_BFI2 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_BFI2", "inst.stat.out", OP_CAT_GED_BFI2, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_JMPI = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_JMPI", "inst.stat.out", OP_CAT_GED_JMPI, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_BRD = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_BRD", "inst.stat.out", OP_CAT_GED_BRD, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_IF = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_IF", "inst.stat.out", OP_CAT_GED_IF, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_BRC = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_BRC", "inst.stat.out", OP_CAT_GED_BRC, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_ELSE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_ELSE", "inst.stat.out", OP_CAT_GED_ELSE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_ENDIF = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_ENDIF", "inst.stat.out", OP_CAT_GED_ENDIF, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_WHILE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_WHILE", "inst.stat.out", OP_CAT_GED_WHILE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_BREAK = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_BREAK", "inst.stat.out", OP_CAT_GED_BREAK, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_CONT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_CONT", "inst.stat.out", OP_CAT_GED_CONT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_HALT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_HALT", "inst.stat.out", OP_CAT_GED_HALT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_CALLA = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_CALLA", "inst.stat.out", OP_CAT_GED_CALLA, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_CALL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_CALL", "inst.stat.out", OP_CAT_GED_CALL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_RET = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_RET", "inst.stat.out", OP_CAT_GED_RET, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_GOTO = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_GOTO", "inst.stat.out", OP_CAT_GED_GOTO, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_JOIN = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_JOIN", "inst.stat.out", OP_CAT_GED_JOIN, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_WAIT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_WAIT", "inst.stat.out", OP_CAT_GED_WAIT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_SEND = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_SEND", "inst.stat.out", OP_CAT_GED_SEND, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_SENDC = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_SENDC", "inst.stat.out", OP_CAT_GED_SENDC, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_SENDS = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_SENDS", "inst.stat.out", OP_CAT_GED_SENDS, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_SENDSC = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_SENDSC", "inst.stat.out", OP_CAT_GED_SENDSC, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_MATH = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_MATH", "inst.stat.out", OP_CAT_GED_MATH, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_ADD = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_ADD", "inst.stat.out", OP_CAT_GED_ADD, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_MUL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_MUL", "inst.stat.out", OP_CAT_GED_MUL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_AVG = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_AVG", "inst.stat.out", OP_CAT_GED_AVG, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_FRC = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_FRC", "inst.stat.out", OP_CAT_GED_FRC, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_RNDU = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_RNDU", "inst.stat.out", OP_CAT_GED_RNDU, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_RNDD = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_RNDD", "inst.stat.out", OP_CAT_GED_RNDD, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_RNDE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_RNDE", "inst.stat.out", OP_CAT_GED_RNDE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_RNDZ = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_RNDZ", "inst.stat.out", OP_CAT_GED_RNDZ, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_MAC = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_MAC", "inst.stat.out", OP_CAT_GED_MAC, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_MACH = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_MACH", "inst.stat.out", OP_CAT_GED_MACH, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_LZD = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_LZD", "inst.stat.out", OP_CAT_GED_LZD, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_FBH = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_FBH", "inst.stat.out", OP_CAT_GED_FBH, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_FBL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_FBL", "inst.stat.out", OP_CAT_GED_FBL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_CBIT = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_CBIT", "inst.stat.out", OP_CAT_GED_CBIT, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_ADDC = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_ADDC", "inst.stat.out", OP_CAT_GED_ADDC, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_SUBB = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_SUBB", "inst.stat.out", OP_CAT_GED_SUBB, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_SAD2 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_SAD2", "inst.stat.out", OP_CAT_GED_SAD2, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_SADA2 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_SADA2", "inst.stat.out", OP_CAT_GED_SADA2, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_DP4 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_DP4", "inst.stat.out", OP_CAT_GED_DP4, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_DPH = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_DPH", "inst.stat.out", OP_CAT_GED_DPH, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_DP3 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_DP3", "inst.stat.out", OP_CAT_GED_DP3, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_DP2 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_DP2", "inst.stat.out", OP_CAT_GED_DP2, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_LINE = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_LINE", "inst.stat.out", OP_CAT_GED_LINE, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_PLN = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_PLN", "inst.stat.out", OP_CAT_GED_PLN, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_MAD = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_MAD", "inst.stat.out", OP_CAT_GED_MAD, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_LRP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_LRP", "inst.stat.out", OP_CAT_GED_LRP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_MADM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_MADM", "inst.stat.out", OP_CAT_GED_MADM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_NOP = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_NOP", "inst.stat.out", OP_CAT_GED_NOP, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_ROR = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_ROR", "inst.stat.out", OP_CAT_GED_ROR, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_ROL = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_ROL", "inst.stat.out", OP_CAT_GED_ROL, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_DP4A = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_DP4A", "inst.stat.out", OP_CAT_GED_DP4A, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_F32TO16 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_F32TO16", "inst.stat.out", OP_CAT_GED_F32TO16, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_F16TO32 = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_F16TO32", "inst.stat.out", OP_CAT_GED_F16TO32, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_DIM = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_DIM", "inst.stat.out", OP_CAT_GED_DIM, OP_CAT_XED_CATEGORY_INVALID);
	m_OP_CAT_GED_INVALID = (COUNT_Stat*) new DISTMember_Stat("OP_CAT_GED_INVALID", "inst.stat.out", OP_CAT_GED_INVALID, OP_CAT_XED_CATEGORY_INVALID);
	...
	m_LLC_WB = new RATIO_Stat("LLC_WB",  "memory.stat.out", LLC_WB, TOTAL_WB, procStat);
	...
	m_LLC_HIT_CPU = new COUNT_Stat("LLC_HIT_CPU", "memory.stat.out", LLC_HIT_CPU);
	m_LLC_HIT_GPU = new COUNT_Stat("LLC_HIT_GPU", "memory.stat.out", LLC_HIT_GPU);
	m_LLC_MISS_CPU = new COUNT_Stat("LLC_MISS_CPU", "memory.stat.out", LLC_MISS_CPU);
	m_LLC_MISS_GPU = new COUNT_Stat("LLC_MISS_GPU", "memory.stat.out", LLC_MISS_GPU);
	m_LLC_HIT_PROMOTION_CPU = new COUNT_Stat("LLC_HIT_PROMOTION_CPU", "memory.stat.out", LLC_HIT_PROMOTION_CPU);
	m_LLC_HIT_PROMOTION_GPU = new COUNT_Stat("LLC_HIT_PROMOTION_GPU", "memory.stat.out", LLC_HIT_PROMOTION_GPU);
	...
	m_UNIQUE_PAGE = new COUNT_Stat("UNIQUE_PAGE", "memory.stat.out", UNIQUE_PAGE);
	m_REALLOCATION = new COUNT_Stat("REALLOCATION", "memory.stat.out", REALLOCATION);
	m_DIST_TLB_HIT = new DIST_Stat("TLB_HIT", "memory.stat.out", TLB_HIT, procStat);
	m_TLB_HIT = (COUNT_Stat*) new DISTMember_Stat("TLB_HIT", "memory.stat.out", TLB_HIT, TLB_HIT);
	m_TLB_MISS = (COUNT_Stat*) new DISTMember_Stat("TLB_MISS", "memory.stat.out", TLB_MISS, TLB_HIT);
	m_DIST_PAGETABLE_HIT = new DIST_Stat("PAGETABLE_HIT", "memory.stat.out", PAGETABLE_HIT, procStat);
	m_PAGETABLE_HIT = (COUNT_Stat*) new DISTMember_Stat("PAGETABLE_HIT", "memory.stat.out", PAGETABLE_HIT, PAGETABLE_HIT);
	m_PAGETABLE_MISS = (COUNT_Stat*) new DISTMember_Stat("PAGETABLE_MISS", "memory.stat.out", PAGETABLE_MISS, PAGETABLE_HIT);
	m_EVICTION = new COUNT_Stat("EVICTION", "memory.stat.out", EVICTION);
	m_AVG_PAGE_FAULTS_PER_BATCH_BASE = new COUNT_Stat("AVG_PAGE_FAULTS_PER_BATCH_BASE", "memory.stat.out", AVG_PAGE_FAULTS_PER_BATCH_BASE);
	m_AVG_PAGE_FAULTS_PER_BATCH = new RATIO_Stat("AVG_PAGE_FAULTS_PER_BATCH",  "memory.stat.out", AVG_PAGE_FAULTS_PER_BATCH, AVG_PAGE_FAULTS_PER_BATCH_BASE, procStat);
	m_MAX_PAGE_FAULTS_PER_BATCH = new RATIO_Stat("MAX_PAGE_FAULTS_PER_BATCH",  "memory.stat.out", MAX_PAGE_FAULTS_PER_BATCH, AVG_PAGE_FAULTS_PER_BATCH_BASE, procStat);
	...
	m_NOC_IDLE_CHANNEL_LLC = new COUNT_Stat("NOC_IDLE_CHANNEL_LLC", "network.stat.out", NOC_IDLE_CHANNEL_LLC);
	...
	m_NOC_AVG_WAIT_IN_ROUTER_BASE_LLC = new COUNT_Stat("NOC_AVG_WAIT_IN_ROUTER_BASE_LLC", "network.stat.out", NOC_AVG_WAIT_IN_ROUTER_BASE_LLC);
	...
	m_NOC_AVG_WAIT_IN_ROUTER_LLC = new RATIO_Stat("NOC_AVG_WAIT_IN_ROUTER_LLC",  "network.stat.out", NOC_AVG_WAIT_IN_ROUTER_LLC, NOC_AVG_WAIT_IN_ROUTER_BASE_LLC, procStat);
	...
	m_POWER_LLC_LINEFILL_BUF_R = new COUNT_Stat("POWER_LLC_LINEFILL_BUF_R", "power_units.stat.out", POWER_LLC_LINEFILL_BUF_R);
	...
	m_POWER_LLC_LINEFILL_BUF_W = new COUNT_Stat("POWER_LLC_LINEFILL_BUF_W", "power_units.stat.out", POWER_LLC_LINEFILL_BUF_W);
	...
	m_POWER_LLC_LINEFILL_BUF_R_TAG = new COUNT_Stat("POWER_LLC_LINEFILL_BUF_R_TAG", "power_units.stat.out", POWER_LLC_LINEFILL_BUF_R_TAG);
	...
	m_POWER_LLC_WB_BUF_R = new COUNT_Stat("POWER_LLC_WB_BUF_R", "power_units.stat.out", POWER_LLC_WB_BUF_R);
	...
	m_POWER_LLC_WB_BUF_W = new COUNT_Stat("POWER_LLC_WB_BUF_W", "power_units.stat.out", POWER_LLC_WB_BUF_W);
	...
	m_POWER_LLC_WB_BUF_R_TAG = new COUNT_Stat("POWER_LLC_WB_BUF_R_TAG", "power_units.stat.out", POWER_LLC_WB_BUF_R_TAG);
	...
	m_POWER_LLC_R = new COUNT_Stat("POWER_LLC_R", "power_units.stat.out", POWER_LLC_R);
	...
	m_POWER_LLC_W = new COUNT_Stat("POWER_LLC_W", "power_units.stat.out", POWER_LLC_W);
	...
	m_POWER_LLC_R_TAG = new COUNT_Stat("POWER_LLC_R_TAG", "power_units.stat.out", POWER_LLC_R_TAG);
...
all_stats_c::~all_stats_c() {
	...
	delete m_SCHED_FAILED_NO_AVAILABLE_PORTS;
	delete m_SCHED_FAILED_NO_MEM_REQ_SLOTS;
	delete m_SCHED_FAILED_NO_AVAILABLE_SIMD_UNIT;
	delete m_SCHED_FAILED_FENCE_ACTIVE;
	delete m_SCHED_FAILED_MEM_MANAGEMENT;
	...
	delete m_OP_CAT_XED_CATEGORY_AVX512;
	delete m_OP_CAT_XED_CATEGORY_AVX512_4FMAPS;
	delete m_OP_CAT_XED_CATEGORY_AVX512_4VNNIW;
	delete m_OP_CAT_XED_CATEGORY_AVX512_BITALG;
	delete m_OP_CAT_XED_CATEGORY_AVX512_VBMI;
	delete m_OP_CAT_XED_CATEGORY_AVX512_VP2INTERSECT;
	delete m_OP_CAT_XED_CATEGORY_BINARY;
	delete m_OP_CAT_XED_CATEGORY_BITBYTE;
	delete m_OP_CAT_XED_CATEGORY_BLEND;
	...
	delete m_OP_CAT_XED_CATEGORY_CET;
	delete m_OP_CAT_XED_CATEGORY_CLDEMOTE;
	delete m_OP_CAT_XED_CATEGORY_CLFLUSHOPT;
	delete m_OP_CAT_XED_CATEGORY_CLWB;
	delete m_OP_CAT_XED_CATEGORY_CLZERO;
	delete m_OP_CAT_XED_CATEGORY_CMOV;
	delete m_OP_CAT_XED_CATEGORY_COMPRESS;
	delete m_OP_CAT_XED_CATEGORY_COND_BR;
	delete m_OP_CAT_XED_CATEGORY_CONFLICT;
	delete m_OP_CAT_XED_CATEGORY_CONVERT;
	delete m_OP_CAT_XED_CATEGORY_DATAXFER;
	delete m_OP_CAT_XED_CATEGORY_DECIMAL;
	delete m_OP_CAT_XED_CATEGORY_ENQCMD;
	delete m_OP_CAT_XED_CATEGORY_EXPAND;
	delete m_OP_CAT_XED_CATEGORY_FCMOV;
	delete m_OP_CAT_XED_CATEGORY_FLAGOP;
	delete m_OP_CAT_XED_CATEGORY_FMA4;
	delete m_OP_CAT_XED_CATEGORY_GATHER;
	delete m_OP_CAT_XED_CATEGORY_GFNI;
	delete m_OP_CAT_XED_CATEGORY_IFMA;
	delete m_OP_CAT_XED_CATEGORY_INTERRUPT;
	delete m_OP_CAT_XED_CATEGORY_IO;
	delete m_OP_CAT_XED_CATEGORY_IOSTRINGOP;
	delete m_OP_CAT_XED_CATEGORY_KMASK;
	delete m_OP_CAT_XED_CATEGORY_LOGICAL;
	delete m_OP_CAT_XED_CATEGORY_LOGICAL_FP;
	delete m_OP_CAT_XED_CATEGORY_LZCNT;
	delete m_OP_CAT_XED_CATEGORY_MISC;
	delete m_OP_CAT_XED_CATEGORY_MMX;
	delete m_OP_CAT_XED_CATEGORY_MOVDIR;
	delete m_OP_CAT_XED_CATEGORY_MPX;
	delete m_OP_CAT_XED_CATEGORY_NOP;
	delete m_OP_CAT_XED_CATEGORY_PCLMULQDQ;
	delete m_OP_CAT_XED_CATEGORY_PCONFIG;
	delete m_OP_CAT_XED_CATEGORY_PKU;
	delete m_OP_CAT_XED_CATEGORY_POP;
	delete m_OP_CAT_XED_CATEGORY_PREFETCH;
	delete m_OP_CAT_XED_CATEGORY_PREFETCHWT1;
	delete m_OP_CAT_XED_CATEGORY_PT;
	delete m_OP_CAT_XED_CATEGORY_PUSH;
	delete m_OP_CAT_XED_CATEGORY_RDPID;
	delete m_OP_CAT_XED_CATEGORY_RDPRU;
	...
	delete m_OP_CAT_XED_CATEGORY_SCATTER;
	delete m_OP_CAT_XED_CATEGORY_SEGOP;
	delete m_OP_CAT_XED_CATEGORY_SEMAPHORE;
	delete m_OP_CAT_XED_CATEGORY_SETCC;
	delete m_OP_CAT_XED_CATEGORY_SGX;
	delete m_OP_CAT_XED_CATEGORY_SHA;
	delete m_OP_CAT_XED_CATEGORY_SHIFT;
	delete m_OP_CAT_XED_CATEGORY_SMAP;
	...
	delete m_OP_CAT_XED_CATEGORY_VAES;
	delete m_OP_CAT_XED_CATEGORY_VBMI2;
	delete m_OP_CAT_XED_CATEGORY_VFMA;
	delete m_OP_CAT_XED_CATEGORY_VIA_PADLOCK;
	delete m_OP_CAT_XED_CATEGORY_VPCLMULQDQ;
	delete m_OP_CAT_XED_CATEGORY_VTX;
	delete m_OP_CAT_XED_CATEGORY_WAITPKG;
	...
	delete m_OP_CAT_XED_CATEGORY_TR_MUL;
	delete m_OP_CAT_XED_CATEGORY_TR_DIV;
	delete m_OP_CAT_XED_CATEGORY_TR_FMUL;
	delete m_OP_CAT_XED_CATEGORY_TR_FDIV;
	delete m_OP_CAT_XED_CATEGORY_TR_NOP;
	delete m_OP_CAT_XED_CATEGORY_PREFETCH_NTA;
	delete m_OP_CAT_XED_CATEGORY_PREFETCH_T0;
	delete m_OP_CAT_XED_CATEGORY_PREFETCH_T1;
	delete m_OP_CAT_XED_CATEGORY_PREFETCH_T2;
	...
	delete m_OP_CAT_GED_ILLEGAL;
	delete m_OP_CAT_GED_MOV;
	delete m_OP_CAT_GED_SEL;
	delete m_OP_CAT_GED_MOVI;
	delete m_OP_CAT_GED_NOT;
	delete m_OP_CAT_GED_AND;
	delete m_OP_CAT_GED_OR;
	delete m_OP_CAT_GED_XOR;
	delete m_OP_CAT_GED_SHR;
	delete m_OP_CAT_GED_SHL;
	delete m_OP_CAT_GED_SMOV;
	delete m_OP_CAT_GED_ASR;
	delete m_OP_CAT_GED_CMP;
	delete m_OP_CAT_GED_CMPN;
	delete m_OP_CAT_GED_CSEL;
	delete m_OP_CAT_GED_BFREV;
	delete m_OP_CAT_GED_BFE;
	delete m_OP_CAT_GED_BFI1;
	delete m_OP_CAT_GED_BFI2;
	delete m_OP_CAT_GED_JMPI;
	delete m_OP_CAT_GED_BRD;
	delete m_OP_CAT_GED_IF;
	delete m_OP_CAT_GED_BRC;
	delete m_OP_CAT_GED_ELSE;
	delete m_OP_CAT_GED_ENDIF;
	delete m_OP_CAT_GED_WHILE;
	delete m_OP_CAT_GED_BREAK;
	delete m_OP_CAT_GED_CONT;
	delete m_OP_CAT_GED_HALT;
	delete m_OP_CAT_GED_CALLA;
	delete m_OP_CAT_GED_CALL;
	delete m_OP_CAT_GED_RET;
	delete m_OP_CAT_GED_GOTO;
	delete m_OP_CAT_GED_JOIN;
	delete m_OP_CAT_GED_WAIT;
	delete m_OP_CAT_GED_SEND;
	delete m_OP_CAT_GED_SENDC;
	delete m_OP_CAT_GED_SENDS;
	delete m_OP_CAT_GED_SENDSC;
	delete m_OP_CAT_GED_MATH;
	delete m_OP_CAT_GED_ADD;
	delete m_OP_CAT_GED_MUL;
	delete m_OP_CAT_GED_AVG;
	delete m_OP_CAT_GED_FRC;
	delete m_OP_CAT_GED_RNDU;
	delete m_OP_CAT_GED_RNDD;
	delete m_OP_CAT_GED_RNDE;
	delete m_OP_CAT_GED_RNDZ;
	delete m_OP_CAT_GED_MAC;
	delete m_OP_CAT_GED_MACH;
	delete m_OP_CAT_GED_LZD;
	delete m_OP_CAT_GED_FBH;
	delete m_OP_CAT_GED_FBL;
	delete m_OP_CAT_GED_CBIT;
	delete m_OP_CAT_GED_ADDC;
	delete m_OP_CAT_GED_SUBB;
	delete m_OP_CAT_GED_SAD2;
	delete m_OP_CAT_GED_SADA2;
	delete m_OP_CAT_GED_DP4;
	delete m_OP_CAT_GED_DPH;
	delete m_OP_CAT_GED_DP3;
	delete m_OP_CAT_GED_DP2;
	delete m_OP_CAT_GED_LINE;
	delete m_OP_CAT_GED_PLN;
	delete m_OP_CAT_GED_MAD;
	delete m_OP_CAT_GED_LRP;
	delete m_OP_CAT_GED_MADM;
	delete m_OP_CAT_GED_NOP;
	delete m_OP_CAT_GED_ROR;
	delete m_OP_CAT_GED_ROL;
	delete m_OP_CAT_GED_DP4A;
	delete m_OP_CAT_GED_F32TO16;
	delete m_OP_CAT_GED_F16TO32;
	delete m_OP_CAT_GED_DIM;
	delete m_OP_CAT_GED_INVALID;
	delete m_FP_OPS_TOT;
	delete m_FP_OPS;
	...
	delete m_LLC_HIT_CPU;
	delete m_LLC_HIT_GPU;
	delete m_LLC_MISS_CPU;
	delete m_LLC_MISS_GPU;
	delete m_LLC_HIT_PROMOTION_CPU;
	delete m_LLC_HIT_PROMOTION_GPU;
	...
	delete m_UNIQUE_PAGE;
	delete m_REALLOCATION;
	delete m_DIST_TLB_HIT;
	delete m_TLB_HIT;
	delete m_TLB_MISS;
	delete m_DIST_PAGETABLE_HIT;
	delete m_PAGETABLE_HIT;
	delete m_PAGETABLE_MISS;
	delete m_EVICTION;
	delete m_AVG_PAGE_FAULTS_PER_BATCH_BASE;
	delete m_AVG_PAGE_FAULTS_PER_BATCH;
	delete m_MAX_PAGE_FAULTS_PER_BATCH;
	...
	delete m_NOC_AVG_WAIT_IN_ROUTER_BASE_LLC;
	...
	delete m_NOC_AVG_WAIT_IN_ROUTER_LLC;
...
void all_stats_c::initialize(ProcessorStatistics* m_ProcessorStats, CoreStatistics* m_coreStatsTemplate) {
	...
	m_ProcessorStats->globalStats()->addStatistic(m_CYC_COUNT_ACC);
	...
	m_ProcessorStats->globalStats()->addStatistic(m_LLC_WB);
	...
	m_ProcessorStats->globalStats()->addStatistic(m_LLC_HIT_CPU);
	m_ProcessorStats->globalStats()->addStatistic(m_LLC_HIT_GPU);
	m_ProcessorStats->globalStats()->addStatistic(m_LLC_MISS_CPU);
	m_ProcessorStats->globalStats()->addStatistic(m_LLC_MISS_GPU);
	m_ProcessorStats->globalStats()->addStatistic(m_LLC_HIT_PROMOTION_CPU);
	m_ProcessorStats->globalStats()->addStatistic(m_LLC_HIT_PROMOTION_GPU);
	...
	m_ProcessorStats->globalStats()->addStatistic(m_UNIQUE_PAGE);
	m_ProcessorStats->globalStats()->addStatistic(m_REALLOCATION);
	m_ProcessorStats->globalStats()->addStatistic(m_TLB_HIT);
	m_ProcessorStats->globalStats()->addStatistic(m_TLB_MISS);
	m_ProcessorStats->globalStats()->addStatistic(m_PAGETABLE_HIT);
	m_ProcessorStats->globalStats()->addStatistic(m_PAGETABLE_MISS);
	m_ProcessorStats->globalStats()->addStatistic(m_EVICTION);
	m_ProcessorStats->globalStats()->addStatistic(m_AVG_PAGE_FAULTS_PER_BATCH_BASE);
	m_ProcessorStats->globalStats()->addStatistic(m_AVG_PAGE_FAULTS_PER_BATCH);
	m_ProcessorStats->globalStats()->addStatistic(m_MAX_PAGE_FAULTS_PER_BATCH);
	...
	m_ProcessorStats->globalStats()->addStatistic(m_NOC_IDLE_CHANNEL_LLC);
	...
	m_ProcessorStats->globalStats()->addStatistic(m_NOC_AVG_WAIT_IN_ROUTER_BASE_LLC);
	...
	m_ProcessorStats->globalStats()->addStatistic(m_NOC_AVG_WAIT_IN_ROUTER_LLC);
	...
	m_ProcessorStats->globalStats()->addStatistic(m_POWER_LLC_LINEFILL_BUF_R);
	m_ProcessorStats->globalStats()->addStatistic(m_POWER_LLC_LINEFILL_BUF_W);
	m_ProcessorStats->globalStats()->addStatistic(m_POWER_LLC_LINEFILL_BUF_R_TAG);
	m_ProcessorStats->globalStats()->addStatistic(m_POWER_LLC_WB_BUF_R);
	m_ProcessorStats->globalStats()->addStatistic(m_POWER_LLC_WB_BUF_W);
	m_ProcessorStats->globalStats()->addStatistic(m_POWER_LLC_WB_BUF_R_TAG);
	m_ProcessorStats->globalStats()->addStatistic(m_POWER_LLC_R);
	m_ProcessorStats->globalStats()->addStatistic(m_POWER_LLC_W);
	m_ProcessorStats->globalStats()->addStatistic(m_POWER_LLC_R_TAG);
	...
	m_DIST_TLB_HIT->addMember(TLB_HIT);
	m_DIST_TLB_HIT->addMember(TLB_MISS);
	m_DIST_PAGETABLE_HIT->addMember(PAGETABLE_HIT);
	m_DIST_PAGETABLE_HIT->addMember(PAGETABLE_MISS);
	...
	m_ProcessorStats->globalStats()->addDistribution(m_DIST_TLB_HIT);
	m_ProcessorStats->globalStats()->addDistribution(m_DIST_PAGETABLE_HIT);
	...
	m_coreStatsTemplate->addStatistic(m_SCHED_FAILED_NO_AVAILABLE_PORTS);
	m_coreStatsTemplate->addStatistic(m_SCHED_FAILED_NO_MEM_REQ_SLOTS);
	m_coreStatsTemplate->addStatistic(m_SCHED_FAILED_NO_AVAILABLE_SIMD_UNIT);
	m_coreStatsTemplate->addStatistic(m_SCHED_FAILED_FENCE_ACTIVE);
	m_coreStatsTemplate->addStatistic(m_SCHED_FAILED_MEM_MANAGEMENT);
	...
	m_coreStatsTemplate->addStatistic(m_PARENT_UOP);
	m_coreStatsTemplate->addStatistic(m_CHILD_UOP_READ);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_ADOX_ADCX);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_AVX512);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_AVX512_4FMAPS);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_AVX512_4VNNIW);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_AVX512_BITALG);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_AVX512_VBMI);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_AVX512_VP2INTERSECT);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_BLEND);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_CET);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_CLDEMOTE);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_CLFLUSHOPT);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_CLWB);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_CLZERO);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_CMOV);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_COMPRESS);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_COND_BR);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_CONFLICT);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_ENQCMD);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_EXPAND);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_GATHER);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_GFNI);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_IFMA);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_KMASK);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_LOGICAL);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_LOGICAL_FP);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_MOVDIR);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_MPX);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_PCONFIG);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_PKU);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_PREFETCHWT1);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_PT);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_PUSH);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_RDPID);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_RDPRU);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_SCATTER);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_SETCC);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_SGX);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_SHA);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_SHIFT);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_SMAP);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_VAES);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_VBMI2);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_VFMA);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_VIA_PADLOCK);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_VPCLMULQDQ);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_VTX);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_WAITPKG);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_TR_MUL);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_TR_DIV);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_TR_FMUL);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_TR_FDIV);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_TR_NOP);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_PREFETCH_NTA);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_PREFETCH_T0);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_PREFETCH_T1);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_XED_CATEGORY_PREFETCH_T2);
	...
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_ILLEGAL);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_MOV);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_SEL);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_MOVI);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_NOT);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_AND);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_OR);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_XOR);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_SHR);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_SHL);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_SMOV);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_ASR);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_CMP);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_CMPN);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_CSEL);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_BFREV);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_BFE);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_BFI1);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_BFI2);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_JMPI);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_BRD);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_IF);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_BRC);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_ELSE);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_ENDIF);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_WHILE);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_BREAK);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_CONT);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_HALT);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_CALLA);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_CALL);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_RET);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_GOTO);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_JOIN);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_WAIT);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_SEND);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_SENDC);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_SENDS);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_SENDSC);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_MATH);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_ADD);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_MUL);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_AVG);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_FRC);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_RNDU);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_RNDD);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_RNDE);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_RNDZ);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_MAC);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_MACH);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_LZD);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_FBH);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_FBL);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_CBIT);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_ADDC);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_SUBB);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_SAD2);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_SADA2);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_DP4);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_DPH);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_DP3);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_DP2);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_LINE);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_PLN);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_MAD);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_LRP);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_MADM);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_NOP);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_ROR);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_ROL);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_DP4A);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_F32TO16);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_F16TO32);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_DIM);
	m_coreStatsTemplate->addStatistic(m_OP_CAT_GED_INVALID);
	...
	m_coreStatsTemplate->addStatistic(m_TRACE_READ_COUNT);
	...
	m_DIST_SCHED_FAILED_REASON_SUCCESS->addMember(SCHED_FAILED_NO_AVAILABLE_PORTS);
	m_DIST_SCHED_FAILED_REASON_SUCCESS->addMember(SCHED_FAILED_NO_MEM_REQ_SLOTS);
	m_DIST_SCHED_FAILED_REASON_SUCCESS->addMember(SCHED_FAILED_NO_AVAILABLE_SIMD_UNIT);
	m_DIST_SCHED_FAILED_REASON_SUCCESS->addMember(SCHED_FAILED_FENCE_ACTIVE);
	m_DIST_SCHED_FAILED_REASON_SUCCESS->addMember(SCHED_FAILED_MEM_MANAGEMENT);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_ADOX_ADCX);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_AVX512);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_AVX512_4FMAPS);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_AVX512_4VNNIW);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_AVX512_BITALG);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_AVX512_VBMI);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_AVX512_VP2INTERSECT);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_BLEND);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_CET);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_CLDEMOTE);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_CLFLUSHOPT);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_CLWB);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_CLZERO);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_CMOV);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_COMPRESS);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_COND_BR);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_CONFLICT);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_ENQCMD);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_EXPAND);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_GATHER);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_GFNI);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_IFMA);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_KMASK);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_LOGICAL);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_LOGICAL_FP);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_MOVDIR);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_MPX);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_PCONFIG);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_PKU);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_PREFETCHWT1);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_PT);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_PUSH);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_RDPID);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_RDPRU);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_SCATTER);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_SETCC);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_SGX);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_SHA);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_SHIFT);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_SMAP);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_VAES);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_VBMI2);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_VFMA);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_VIA_PADLOCK);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_VPCLMULQDQ);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_VTX);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_WAITPKG);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_TR_MUL);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_TR_DIV);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_TR_FMUL);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_TR_FDIV);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_TR_NOP);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_PREFETCH_NTA);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_PREFETCH_T0);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_PREFETCH_T1);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_XED_CATEGORY_PREFETCH_T2);
	...
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_ILLEGAL);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_MOV);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_SEL);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_MOVI);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_NOT);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_AND);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_OR);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_XOR);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_SHR);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_SHL);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_SMOV);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_ASR);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_CMP);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_CMPN);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_CSEL);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_BFREV);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_BFE);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_BFI1);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_BFI2);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_JMPI);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_BRD);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_IF);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_BRC);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_ELSE);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_ENDIF);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_WHILE);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_BREAK);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_CONT);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_HALT);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_CALLA);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_CALL);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_RET);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_GOTO);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_JOIN);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_WAIT);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_SEND);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_SENDC);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_SENDS);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_SENDSC);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_MATH);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_ADD);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_MUL);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_AVG);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_FRC);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_RNDU);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_RNDD);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_RNDE);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_RNDZ);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_MAC);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_MACH);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_LZD);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_FBH);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_FBL);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_CBIT);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_ADDC);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_SUBB);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_SAD2);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_SADA2);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_DP4);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_DPH);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_DP3);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_DP2);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_LINE);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_PLN);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_MAD);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_LRP);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_MADM);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_NOP);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_ROR);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_ROL);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_DP4A);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_F32TO16);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_F16TO32);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_DIM);
	m_DIST_OP_CAT_XED_CATEGORY_INVALID->addMember(OP_CAT_GED_INVALID);
