...
all_knobs_c::all_knobs_c() {
	...
	KNOB_ROB_SIZE = new KnobTemplate< uns16 > ("rob_size", 352);
	KNOB_ROB_MEDIUM_SIZE = new KnobTemplate< uns16 > ("rob_medium_size", 352, "rob_size");
	KNOB_ROB_LARGE_SIZE = new KnobTemplate< uns16 > ("rob_large_size", 352, "rob_size");
	...
	KNOB_MEU_NSB = new KnobTemplate< uns16 > ("meu_nsb", 128);
	KNOB_MEU_NLB = new KnobTemplate< uns16 > ("meu_nlb", 128);
	KNOB_MEU_MEDIUM_NSB = new KnobTemplate< uns16 > ("meu_medium_nsb", 128, "meu_nsb");
	KNOB_MEU_MEDIUM_NLB = new KnobTemplate< uns16 > ("meu_medium_nlb", 128, "meu_nlb");
	KNOB_MEU_LARGE_NSB = new KnobTemplate< uns16 > ("meu_large_nsb", 128, "meu_nsb");
	KNOB_MEU_LARGE_NLB = new KnobTemplate< uns16 > ("meu_large_nlb", 128, "meu_nlb");
