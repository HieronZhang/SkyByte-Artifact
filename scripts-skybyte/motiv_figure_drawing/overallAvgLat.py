...
if inc_base:
  ax0.set_yticks(np.arange(0, 1200, 200))
  ax0.set_ylim([0, 1200])
else:
...
if inc_base:
  fig.savefig(f"output/OverallAvgLat.png", bbox_inches=extent)
  fig.savefig(f"output/OverallAvgLat.pdf", bbox_inches=extent)
else:
