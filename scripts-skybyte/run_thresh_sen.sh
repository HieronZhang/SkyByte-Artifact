...
# baselines=( "$baselines_dir"/assd-W.config "$baselines_dir"/assd-WP.config "$baselines_dir"/flatflash.config)
...
workloads=( "$workloads_dir"/*24.config "$workloads_dir"/*40.config)
settings=( "$settings_dir"/*.config )
