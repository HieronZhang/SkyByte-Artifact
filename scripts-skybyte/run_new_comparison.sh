...
baselines=( "$baselines_dir"/assd-Full-rr.config "$baselines_dir"/assd-WCT.config)
...
baselines=( "$baselines_dir"/assd-CP.config "$baselines_dir"/assd-CT.config "$baselines_dir"/assd-CA.config)
workloads=( "$workloads_dir"/*24.config  "$workloads_dir"/*48.config)
# settings=( "$settings_dir"/*.config )
